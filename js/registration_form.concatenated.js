        ...
        $.get(
          ...
          function (response) {
            if(response.status == 1) {
              ...
              $('input[name=captcha_hash]', $form).val(response.data.captcha_hash);
            }
            else {
...
(function($) {
        ...
        $.validator.passwordRating = function(password, username) {
                ...
                if (lower && upper || lower && digits || upper && digits) {
        ...
        $.validator.addMethod("password", function(value, element, usernameField) {
                ...
                // Password meter must not be false
