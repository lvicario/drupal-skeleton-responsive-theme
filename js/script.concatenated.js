...
(function($){
    ...
    $('.ui-datepicker').insertAfter('#dob');


    function tabletCountryMove() {
    	var windowWidth = $(window).width();

    	if (windowWidth >= 768 && windowWidth <= 1023) {
    		$('.form-item-country').appendTo('.col-2');
    	} else if (windowWidth >= 1024) {
    		$('.form-item-country').appendTo('.col-3');
    	}
    }
    tabletCountryMove();
	...
	function stickyFooter() {
		...
		if (wrapHeight <= windowHeight || $('body').hasClass('page-lobby')) {
	 ...
	 */
	// var tooltip_icon = function (elem , error)
	// {
	//     var parent = $(elem).parent();
	//     var marker = parent.find('span.mark');

	//    // console.log();
	//    console.log('tooltip_icons');
 ...
 //            marker.css("width", "30px");
  ...
  //   $("#matterhorn-registration-form").validate({
		// errorClass: "error",
		// errorPlacement: function(error, element) {
		// 	console.log('validate error placement');
		// 	var marker = tooltip_icon(element , error);
